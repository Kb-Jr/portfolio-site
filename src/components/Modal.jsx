              ...
              <div className="modal-body">
                ...
                <div className="modal-body-bottom">
                  <div className="left-modal">
                    ...
                    <div className="links">
                      {props.github ? (<button onClick={
                        () => window.open(`${props.github}`, '_blank', 'noopener')
                        }><p><FontAwesomeIcon icon="fa-brands fa-github" className='links-icon' />Github repo link</p></button>) : ('')}

                      {props.live ? (<button onClick={
                        () => window.open(`${props.live}`, '_blank', 'noopener')
                        }><p><FontAwesomeIcon icon="fa-solid fa-link" className='links-icon' />Live Link</p></button>) : ('')}
